...
const AddMenuItemForm = ({
  ...
  const onSubmit: SubmitHandler<AddMenuFormFields> = (data) => console.log(data)
  console.log(errors);
  return (
    <>
        <form
        ...
        >
          ...
          <Image className="absolute left-3 top-1/2 transform -translate-y-1/2" src={searchIcon} alt="search icon"/>
          <input
            id="Link"
            type="text"
          ...
          <div className="flex gap-4 w-full">
            <ButtonSecondary text="Anuluj" onClick={() => setShowAddMenuItemForm(false)}/>
